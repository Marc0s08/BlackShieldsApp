    ...
    <Router>
      <div className="App">
        ...
        <div className="buttons-container">
          ...
          <Link to="/page4"><button>Tournement de X1</button></Link>
        </div>
      </div>
      <Routes>
        ...
        <Route path="/page4" exact element={<Page3 playersCollection={collection(db, 'players4')} />} />
      </Routes>
    </Router>
  );
}
